<template>
  <header :class="`main-header2 header-style-two ${sticky ? 'fixed-header' : ''}`">
          ...
          <nav class="main-menu navbar-expand-md navbar-light">
            <div class="collapse navbar-collapse show clearfix">
              <ul class="navigation clearfix">
                ...
                <li @click="swithLang"  class="dropdown">Portfolio
                  <ul>
    ...
    <nav class="mobile-nav__container">
      ...
      <div :class="`collapse navbar-collapse ${mobileToggle ? 'show' : ''} clearfix`">
        <ul class="navigation clearfix">
          ...
          <li @click="swithLang" class="dropdown">Portfolio<div class="dropdown-btn"><span class="fa fa-angle-right"></span></div>
            <ul class="sub-menu">
              <li><nuxt-link to="/portfolio">Portfolio</nuxt-link></li>
              <li><nuxt-link to="/portfolio-single">Portfolio Single 01</nuxt-link></li>
              <li><nuxt-link to="/portfolio-single-2">Portfolio Single 02</nuxt-link></li>

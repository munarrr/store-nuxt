    ...
    <div class="auto-container">
      ...
      <div class="mixitup-gallery">
        <div class="upper-row clearfix">
          <div class="sec-title">
            <h2>Выбрать категорию:<span class="dot">.</span></h2>
          </div>
          <!--Filter-->
          <div class="filters clearfix">
            <ul class="filter-tabs filter-btns clearfix">
              <li class="filter mixitup-control-active" data-role="button" data-filter="all">All<sup></sup></li>
              <li class="filter" data-role="button" data-filter=".branding">Свитер<sup></sup></li>
              <li class="filter" data-role="button" data-filter=".illustration">Кофта<sup></sup></li>
              <li class="filter" data-role="button" data-filter=".photography">Трико<sup></sup></li>
              <li class="filter" data-role="button" data-filter=".web-design">Аксесуар<sup></sup></li>
            </ul>
          </div>
        </div>
